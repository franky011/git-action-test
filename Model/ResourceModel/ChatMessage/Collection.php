 ...
 */
namespace Lofmp\ChatSystem\Model\ResourceModel\ChatMessage;
...
class Collection extends AbstractCollection
{
    ...
    {
        //$this->performAfterLoad('lofmp_chatsystem_category_store', 'category_id');
    ...
    {
        $this->_init('Lofmp\ChatSystem\Model\ChatMessage', 'Lofmp\ChatSystem\Model\ResourceModel\ChatMessage');
    }
